...
TaxCalculator.prototype.getTaxRate = function () {
    switch (this.getProvinceId()) {
        ...
        case "1101":            return 0.05; // 0.12; // British Columbia
        case "1102":            return 0.05; // 0.13; // Manitoba
        case "1103":            return 0.15; // New-Brunswick
        case "1104":            return 0.15; // Newfoundland and Labrador
        ...
        case "1110":            return 0.05; // 0.14975; // Quebec
        case "1111":            return 0.05; // 0.10; // Saskatchewan
...
TaxCalculator.prototype.getTaxTerm = function () {
    switch(this.getProvinceId()) {
      case "1100": return "GST"; // Alberta
      case "1101": return "GST"; // British Columbia
      case "1102": return "GST"; // Manitoba
      case "1103": return "HST"; // New-Brunswick
      case "1104": return "HST"; // Newfoundland and Labrador
      case "1105": return "GST"; // Northwest Territories
      case "1106": return "HST"; // Nova Scotia
      case "1107": return "GST"; // Nunavut
      case "1108": return "HST"; // Ontario
      case "1109": return "HST"; // Prince Edward Island
      case "1110": return "GST"; // Quebec
      case "1111": return "GST"; // Saskatchewan
      case "1112": return "GST"; // Yukon Territory
